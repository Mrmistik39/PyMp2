...
from src.PyMp.Network.raklib import Queue
from src.PyMp.Network.raklib.server.SessionManager import SessionManager
from src.PyMp.Network.raklib.server.UDPServerSocket import UDPServerSocket
...
class PyRakLibServer(Thread):
    ...
    def shutdownHandler(self):
        if self._shutdown is not True:
            self.logger.error("RakLib Thread [#"+str(self.ident)+"] crashed.")
    ...
    def run(self):
        ...
        socket = UDPServerSocket(self.port, self.interface)
